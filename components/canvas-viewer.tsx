          ...
          {(controls: ReactZoomPanPinchRef) => (
            <>
              ...
              <div className="absolute left-4 top-4 z-10 rounded-md border border-[#dfe3e8] bg-white/95 px-3 py-2 text-xs font-semibold text-[#3b414a] shadow-sm backdrop-blur">
                {comparison.mode === "original" || beforeAfterEnabled
                  ? "Vista original"
              ...
              >
                <div className="flex h-full min-h-[480px] w-full items-center justify-center gap-5 p-8">
                  {comparison.mode === "side-by-side" ? (
                    <>
                      <div
                      ...
                      >
                        <Image
                          ...
                          draggable={false}
                        />
                        <span className="absolute left-3 top-3 rounded bg-black/65 px-2 py-1 text-xs font-semibold text-white">
                          Original
                        </span>
                      </div>
                      <div
                    ...
                    <div
                      ...
                      style={{
                        width: image.dimensions.width,
                        height: image.dimensions.height,
                        backgroundColor: maskOnlyPreview
                          ? "#20242a"
                          : undefined,
                        backgroundImage: maskOnlyPreview
                          ...
                          : undefined,
                        backgroundSize: maskOnlyPreview
                          ? "32px 32px"
                          : undefined,
                        backgroundPosition: maskOnlyPreview
                    ...
                    >
                      ...
                      {comparison.mode !== "original" ? (
                        <div
                          ...
                          style={
                            ...
                            comparison.mode === "split-vertical"
                              ? {
                                  clipPath: `inset(0 ${100 - comparison.comparisonPosition}% 0 0)`,
                                }
                              : comparison.mode === "split-horizontal"
                                ? {
                                    clipPath: `inset(0 0 ${100 - comparison.comparisonPosition}% 0)`,
                                  }
                                : undefined
                          }
                        >
                      ...
                      {comparison.mode === "slider" ||
                      comparison.mode === "split-vertical" ? (
                        <BeforeAfterSlider direction="vertical" />
                      ) : comparison.mode === "split-horizontal" ? (
                        <BeforeAfterSlider direction="horizontal" />
                      ) : null}
                    </div>
                  )}
                </div>
